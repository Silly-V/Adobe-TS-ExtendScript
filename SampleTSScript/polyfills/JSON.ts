...
"object"!=typeof JSON&&((JSON as any)={}),function(){"use strict";function f(t){return 10>t?"0"+t:t}function quote(t){
    ...
    case"boolean":case("null" as any):return String(p);case"object":if(!p)return"null";if(gap+=indent,u=[],"[object Array]"===Object.prototype.toString.apply(p)){
      ...
      u.join(",\n"+gap)+"\n"+i+"}":"{"+u.join(",")+"}",gap=i,o}}"function"!=typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){
        ...
        f(this.getUTCMinutes())+":"+f(this.getUTCSeconds())+"Z":null},(String.prototype as any).toJSON=(Number.prototype as any).toJSON=(Boolean.prototype as any).toJSON=function(){
...
function JSONFormat (inObj: any): string {
  return JSON.stringify(inObj).replace(/\{[.\n]+\}/g, "{}").replace(/\[[.\n]+\]/g, "[]");
}